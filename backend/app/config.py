...
class Settings(BaseSettings):
    ...
    # SD-WAN (Infinity Portal) — used to assign a gateway to an SD-WAN profile
    sd_wan_client_id: str = ""
    sd_wan_client_secretkey: str = ""
    sd_wan_client_auth_url: str = "https://cloudinfra-gw.portal.checkpoint.com/auth/external"
    sd_wan_graphql_url: str = "https://cloudinfra-gw.portal.checkpoint.com/app/sd-wan/graphql/v1"
